...
public class SlashActionRepositoryTest {
	...
	private static final String XML_ACTION = "XMLAction";
	...
	@Test
	public void testGet() {
		assertThat(SlashActionRepository.get("alter").toString(), containsString(XML_ACTION));
		assertThat(SlashActionRepository.get("/").toString(), containsString("RemessageAction"));
		assertThat(SlashActionRepository.get("add").toString(), containsString(XML_ACTION));
		assertThat(SlashActionRepository.get("adminlevel").toString(), containsString("AdminLevelAction"));
		assertThat(SlashActionRepository.get("alter").toString(), containsString(XML_ACTION));
		assertThat(SlashActionRepository.get("altercreature").toString(), containsString(XML_ACTION));
		...
		assertThat(SlashActionRepository.get("gag").toString(), containsString(XML_ACTION));
		...
		assertThat(SlashActionRepository.get("inspect").toString(), containsString(XML_ACTION));
		assertThat(SlashActionRepository.get("invisible").toString(), containsString(XML_ACTION));
		assertThat(SlashActionRepository.get("jail").toString(), containsString(XML_ACTION));
		...
		assertThat(SlashActionRepository.get("remove").toString(), containsString(XML_ACTION));
		...
		assertThat(SlashActionRepository.get("supportanswer").toString(), containsString(XML_ACTION));
		assertThat(SlashActionRepository.get("supporta").toString(), containsString("SupportAnswerAction"));
		assertThat(SlashActionRepository.get("support").toString(), containsString(XML_ACTION));
		assertThat(SlashActionRepository.get("teleport").toString(), containsString(XML_ACTION));
		assertThat(SlashActionRepository.get("teleportto").toString(), containsString("TeleportToAction"));
		assertThat(SlashActionRepository.get("tellall").toString(), containsString(XML_ACTION));
		...
		assertThat(SlashActionRepository.get("who").toString(), containsString(XML_ACTION));
