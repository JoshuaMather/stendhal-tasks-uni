...
public class SlashActionRepositoryTest {
	...
	@Test
	public void testGet() {
		assertThat(SlashActionRepository.get("alter").toString(), containsString("XMLAction"));
		assertThat(SlashActionRepository.get("/").toString(), containsString("RemessageAction"));
		assertThat(SlashActionRepository.get("add").toString(), containsString("XMLAction"));
		assertThat(SlashActionRepository.get("adminlevel").toString(), containsString("AdminLevelAction"));
		assertThat(SlashActionRepository.get("alter").toString(), containsString("XMLAction"));
		assertThat(SlashActionRepository.get("altercreature").toString(), containsString("XMLAction"));
		...
		assertThat(SlashActionRepository.get("gag").toString(), containsString("XMLAction"));
		...
		assertThat(SlashActionRepository.get("inspect").toString(), containsString("XMLAction"));
		assertThat(SlashActionRepository.get("invisible").toString(), containsString("XMLAction"));
		assertThat(SlashActionRepository.get("jail").toString(), containsString("XMLAction"));
		...
		assertThat(SlashActionRepository.get("remove").toString(), containsString("XMLAction"));
		...
		assertThat(SlashActionRepository.get("supportanswer").toString(), containsString("XMLAction"));
		assertThat(SlashActionRepository.get("supporta").toString(), containsString("SupportAnswerAction"));
		assertThat(SlashActionRepository.get("support").toString(), containsString("XMLAction"));
		assertThat(SlashActionRepository.get("teleport").toString(), containsString("XMLAction"));
		assertThat(SlashActionRepository.get("teleportto").toString(), containsString("TeleportToAction"));
		assertThat(SlashActionRepository.get("tellall").toString(), containsString("XMLAction"));
		...
		assertThat(SlashActionRepository.get("who").toString(), containsString("XMLAction"));
